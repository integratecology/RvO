...
for(i in 1:length(samp)){
  ...
  #################################
   ...
   x <- data.frame(sim_no, nd, agdeRngArea, krigeOccArea)
  
   # Store results in data.frame
   write.table(x, 'sims_RvO_sd.csv', append=TRUE, row.names=FALSE, col.names=FALSE, sep=',') 
